	...
	:mRenderType(Particle::RenderType::Rectangle)
{
	...
	mImageList[RubbleType::Meat].emplace_back(_ImageManager->FindImage("rubble"), 6, 2);
}
...
void ParticleRenderOption::OnGui()
{
	if (ImGui::CollapsingHeader("Render"))
	{
		...
		if (ImGui::Combo("RubbleType", &selectRubbleType, "Stage1Rock\0Stage2Rock\0Stage3Rock\0Leaf\0RedRubble\0Meat"))
